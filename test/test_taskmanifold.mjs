...
const design = { selfVerifiable: false, frameGiven: false, reflexConfidentlyWrong: true, smoothCrux: false };
...
const oracled = judge({ selfVerifiable: true, frameGiven: false, reflexConfidentlyWrong: true, smoothCrux: false });
ok(oracled.verdict === 'TOO EASY', `hand the agent a local oracle and it is ${oracled.verdict}`);
ok(oracled.because.includes('burying more secrets'),
  '  because: ' + oracled.because);

const smooth = judge({ selfVerifiable: false, frameGiven: false, reflexConfidentlyWrong: true, smoothCrux: true });
...
const never = judge({ selfVerifiable: false, frameGiven: true, reflexConfidentlyWrong: false, smoothCrux: false });
...
ok(AXES.selfVerifiable.includes('local oracle'), 'selfVerifiable: ' + AXES.selfVerifiable.slice(0, 60) + '...');
